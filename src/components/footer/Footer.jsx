    ...
    <div className="footer">
      <div className="footer-body">
        ...
        <div className="footer-body-section">
          ...
          <a className="footer-body-contactus-item" href={`tel:${contactInfo.phone}`}>
            ...
            <span className="footer-body-contactus-item-typo">{contactInfo.phone}</span>
          </a>
          <div className="footer-body-contactus-item">
            ...
            <span className="footer-body-contactus-item-typo">{contactInfo.location}</span>
          </div>
          <a className="footer-body-contactus-item" href={`mailto:${contactInfo.mainEmail}`}>
            ...
            <span className="footer-body-contactus-item-typo">{contactInfo.mainEmail}</span>
          </a>
        </div>
      </div>
