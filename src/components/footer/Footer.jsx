  ...
  return (
    <div className="footer">
      <div className="footer-body">
        <div className="footer-body-company-section">
          <NavLink className="footer-body-company-section-logo-link" to="/">
            <img className="footer-body-company-section-logo" src="/logo-full.svg" alt="logo" />
          </NavLink>
        </div>
        <div className="footer-body-section">
          <div className="footer-body-section-heading">
        ...
        <div className="footer-body-section">
          ...
          <a className="footer-body-contactus-item" href="tel:+971501231234">
            ...
            <span className="footer-body-contactus-item-typo">+971 50 123 1234</span>
          </a>
          <div className="footer-body-contactus-item">
            ...
            <span className="footer-body-contactus-item-typo">Abu Dhabi, United Arab Emirates</span>
          </div>
          <a className="footer-body-contactus-item" href="mailto:consult@growmoreinternational.com">
            ...
            <span className="footer-body-contactus-item-typo">consult@growmoreinternational.com</span>
          </a>
        </div>
      </div>
      <div className="footer-copyright-section">
        ...
        <a href="https://www.amnuz.com/?utm=growmore" target="https://www.amnuz.com/?utm=growmore">
